    ...
    <main class="mb-5">
        ...
        <section id="privacy" class="container page-section">
            ...
            <div class="container terms shadow-sm rounded-3">
                ...
                <h4 class="text-center mb-5">www.groundsound.com</h4>
                <div class="mb-4">
                    <p>
                ...
                <div class="mb-4">
                    <h5><b>Cookies propias</b></h5>
                    <p>
                        Son aquellas cookies que son enviadas al ordenador o dispositivo del Usuario y gestionadas
                        exclusivamente por GroundSound Festival para el mejor funcionamiento del Sitio Web. La información que
                        se recaba se emplea para mejorar la calidad del Sitio Web y su Contenido y su experiencia como Usuario.
                ...
                <div class="mb-4">
                    <h5><b>Deshabilitar, rechazar y eliminar cookies</b></h5>
                    <p>
