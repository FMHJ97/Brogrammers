    ...
    <main>
        <section class="page-section">
            ...
            <div class="container">
                ...
                <!-- Row Cards with Parking prices -->
                <div class="row" id="rowParking">

                    <!-- General Parking Card -->
                    <div class="col-md-4">
                ...
                <!-- Row Cards with Camping prices -->
                <div class="row d-none" id="rowCamping">
